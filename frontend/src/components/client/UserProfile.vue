...
const achievements = ref([
  ...
  },
  {
    ...
    icon: 'bi-people',
    description: 'Chia sẻ 5 quiz công khai',
    earned: true,
    earnedAt: '2024-01-20',
  },
  {
    ...
    recentActivities.value = [
      {
        id: 1,
        type: 'quiz_created',
        message: 'Bạn đã tạo quiz "JavaScript Basics"',
        time: '2 giờ trước',
        icon: 'bi-plus-circle',
      },
      {
        id: 2,
        type: 'quiz_completed',
        message: 'Hoàn thành quiz "Vue.js Advanced" với điểm 95',
        time: '1 ngày trước',
      ...
      },
      {
        id: 3,
        type: 'achievement',
        message: 'Đạt được thành tựu "Quiz Master"',
        time: '3 ngày trước',
        icon: 'bi-award',
      },
      {
                        ...
                        <div class="form-group">
                          ...
                          <div class="avatar-upload">
                            <div class="current-avatar">
                              <img
                                :src="
                                  avatarPreview || userData.avatarUrl || '/img/default-avatar.png'
                                "
                                alt="Avatar Preview"
                  ...
                  <div class="card-body">
                    <form @submit.prevent="changePassword">
                      ...
                      <div class="form-group">
                        ...
                        <div class="password-input">
                          ...
                          >
                            <div
                              class="eye-icon"
                              :class="{ 'eye-hidden': showCurrentPassword }"
                            ></div>
                          </button>
                        </div>
                        <div
                          class="verify-hint"
                          :class="{
                            ok: isCurrentPasswordValid,
                            err: currentPasswordMsg && !isCurrentPasswordValid,
                          }"
                        >
                      ...
                      <div class="form-group">
                        ...
                        <div class="password-input">
                          <input
                            ...
                            class="form-input"
                            :class="{
                              'input-error': passwordForm.newPassword && newPasswordInvalid,
                            }"
                        ...
                        <ul v-if="passwordForm.newPassword" class="hint-list">
                          <li :class="{ ok: !newPasswordHints.tooShort8 }">Tối thiểu 8 ký tự</li>
                          <li :class="{ ok: !newPasswordHints.lower }">Có chữ thường (a–z)</li>
                          <li :class="{ ok: !newPasswordHints.upper }">Có chữ hoa (A–Z)</li>
                          <li :class="{ ok: !newPasswordHints.digit }">Có số (0–9)</li>
                          <li :class="{ ok: !newPasswordHints.special }">
                            Có ký tự đặc biệt (@#$%...)
                          </li>
                        </ul>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="password-input">
                          <input
                            ...
                            :class="{
                              ...
                              'input-error':
                                passwordForm.confirmPassword && passwordMatch === false,
                            }"
                          ...
                          >
                            <div
                              class="eye-icon"
                              :class="{ 'eye-hidden': showConfirmPassword }"
                            ></div>
                          </button>
                        </div>
                        ...
                        <!-- lỗi ngắn gọn -->
                        <p
                          v-if="passwordForm.confirmPassword && passwordMatch === false"
                          class="field-error"
                        >
...
.input-error {
  ...
  box-shadow: 0 0 0 0.2rem rgba(255, 71, 87, 0.15) !important;
}
