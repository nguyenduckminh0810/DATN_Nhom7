...
const getStrengthColor = (strength) => {
    switch(strength) {
        case 1: return '#ff4757'  // Yếu
        case 2: return '#ffa502'  // Trung bình
        case 3: return '#2ed573'  // Mạnh  
        case 4: return '#1e90ff'  // Rất mạnh
        case 5: return '#8e44ad'  // Xuất sắc
        default: return '#ddd'
    }
}
...
<template>
    <div class="register-page">
        ...
        <!-- Success/Error States (same as before) -->
