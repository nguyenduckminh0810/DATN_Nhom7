<template>
  <div class="ban-page">
    ...
    <div class="card">
      ...
      <p class="subtitle">
        Bạn không thể tiếp tục sử dụng hệ thống do vi phạm chính sách hoặc bị quản trị viên hạn chế
        quyền.
      </p>
      ...
      <div class="actions">
        <button class="btn primary" @click="relogin">Đăng nhập tài khoản khác</button>
...
.card::before {
  ...
  border-radius: 20px;
  padding: 1px;
  background: linear-gradient(135deg, rgba(32, 211, 243, 0.45), rgba(255, 92, 122, 0.4));
  -webkit-mask:
...
.icon-wrap {
  ...
  margin: 4px 0 12px;
  background:
    radial-gradient(120px 120px at 20% 10%, rgba(32, 211, 243, 0.25), transparent 40%),
    radial-gradient(140px 120px at 80% 90%, rgba(255, 92, 122, 0.18), transparent 50%),
    rgba(255, 255, 255, 0.06);
  border: 1px solid rgba(255, 255, 255, 0.12);
  box-shadow:
    0 8px 24px rgba(32, 211, 243, 0.15),
...
.btn.primary {
  ...
  box-shadow: 0 8px 26px rgba(32, 211, 243, 0.25);
}

.btn.primary:hover {
  transform: translateY(-1px);
  box-shadow: 0 12px 32px rgba(32, 211, 243, 0.32);
}
